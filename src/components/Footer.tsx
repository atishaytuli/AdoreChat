    ...
    <img src="./pink.jpg" alt="Couple connecting" className="w-full h-[600px] object-cover rounded-lg mb-22" style={{ background: "linear-gradient(90deg, #44ff9a -0.55%, #44b0ff 22.86%, #8b44ff 48.36%, #ff6644 73.33%, #ebff70 99.34%)" }}/>
        ...
        <div className="lg:flex lg:items-center lg:justify-between mt-14 lg:mt-52">
            ...
            <ul className="flex items-center justify-center mt-8 space-x-6 sm:mt-12 sm:space-x-16 lg:mt-0">
                <li>
                    <a href="#" title="" className="text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">About AdoreChat</a>
                </li>

                <li>
                    <a href="#" title="" className="text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">Features</a>
                </li>

                <li>
                    <a href="#" title="" className="text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">How It Works</a>
                </li>

                <li>
                    <a href="#" title="" className="text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">Support</a>
                </li>
            </ul>
