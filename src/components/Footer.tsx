                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="lg:flex lg:items-center lg:justify-between mt-14 lg:mt-52">
                        ...
                        <ul className="flex items-center justify-center mt-8 space-x-6 sm:mt-12 sm:space-x-16 lg:mt-0">
                            <li>
                                <a href="#" title="" className="md:text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">About AdoreChat</a>
                            </li>

                            <li>
                                <a href="#" title="" className="md:text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">Features</a>
                            </li>

                            <li>
                                <a href="#" title="" className="md:text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">How It Works</a>
                            </li>

                            <li>
                                <a href="#" title="" className="md:text-lg font-medium text-gray-900 transition-all duration-200 font-pj hover:text-gray-600">Support</a>
                            </li>
                        </ul>
                    ...
                    <div className="mt-10 md:flex md:items-center md:justify-between">
                        <ul className="flex items-center justify-center space-x-6 md:order-2 md:justify-end">
                            <li>
                                <a href="#" title="" className="text-base font-normal text-gray-600 transition-all duration-200 font-pj hover:text-gray-900">Privacy Policy</a>
                            </li>

                            <li>
                                <a href="#" title="" className="text-base font-normal text-gray-600 transition-all duration-200 font-pj hover:text-gray-900">Terms & Conditions</a>
                            </li>
                        </ul>

                        <p className="mt-8 text-base font-normal text-center text-gray-600 md:text-left md:mt-0 md:order-1 font-pj">Stay Connected with AdoreChat | © 2025 AdoreChat, All Rights Reserved</p>
                    </div>
                </div>
            </footer>
        </>
