  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-900 font-pj">Discover the Magic of Crafting</h2>
                <p className="max-w-md mx-auto mt-5 text-base font-normal text-gray-600 font-pj">Unleash your creativity with our wide selection of crafting materials. Start creating today!</p>
        </div>
        ...
        <p className="mt-6 text-sm font-normal text-center text-gray-500 font-pj">No limits. No boundaries. Just pure creative freedom</p>
    </div>
</section>
    </>
  )
